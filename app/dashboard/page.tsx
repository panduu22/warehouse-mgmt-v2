                    ...
                    <div className="space-y-6">
                        {data.recentTrips.length === 0 ? (
                            ...
                            data.recentTrips.map((trip: any) => (
                                <div key={trip._id} className="flex items-center justify-between group cursor-pointer hover:bg-gray-50 p-4 -mx-4 rounded-2xl transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900">{trip.vehicleId?.number || "Unknown Vehicle"}</h4>
                                            <p className="text-sm text-gray-500 flex items-center gap-2">
                                                <span className="font-medium text-gray-700">{trip.vehicleId?.driverName}</span>
